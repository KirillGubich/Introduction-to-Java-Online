...
public class Time implements Comparable<Time> {
	...
	public int compareTo(Time o) {
		...
		int result;
		result = Integer.valueOf(this.hours).compareTo(o.hours);
		...
		result = Integer.valueOf(this.minutes).compareTo(o.minutes);
		...
		result = Integer.valueOf(this.seconds).compareTo(o.seconds);
